...
@if(Auth::user()->admin())
	<div class="card text-white bg-primary mb-3 mt-3">
		<div class="card-header">
			<h3>Pruebas Didacticas</h3>
		</div>
			<div class="card-body">

				<a href="{{route('pruebasD.create')}}" class="btn btn-success">Registrar nueva prueba</a><hr>

	<table class="table table-striped">
		<thead class="text-white">
			<th>ID</th>
			<th>Prueba Didactica</th>
			...
			@foreach($pruebas as $prueba)
				<tr data-id="{{$prueba->id}}" class="text-white">
					...
					<td>
						...
						<a href="{{ route('pruebasD.edit', $prueba->id) }}" class="btn btn-warning"><i class="fas fa-users"></i></a>
					</td>
				</tr>
			@endforeach
		</tbody>
	...
	{!! Form::open(['route' => ['pruebasD.destroy', ':PRUEBA_ID'], 'method' => 'DELETE', 'id' => 'form-delete']) !!}
	{!! Form::close() !!}
