...
@section('contenido')
	...
	<div class="card text-white bg-primary mb-3 mt-3">
		<div class="card-header">
			<h3>Editar Pruebas Didacticas</h3>
		</div>
		<div class="card-body">

		{!!Form::open(['route' => ['pruebasD.update', $prueba], 'method' => 'PUT','class' => 'form-inline'])!!}
...
<script>
	$('.select-pregunta').chosen({
		placeholder_text_multiple: 'Seleccione un maximo de 3 preguntas',
