...
@section('title', 'Pruebas Didacticas')

@section('head', 'Pruebas Didacticas')
						...
						@foreach($pruebas as $prueba)
							<div class="card" style="width: 18rem; margin-left: 10px; background-color: #5FCC4D ;padding: 4px;
  								...
  								<div class="card-body">
    								...
    								<a href="{{ route('front.view.resultados.create1', $prueba->id) }}" class="card-link" style="color: #FCFAFD; background-color: #3064BB; border-radius: 4px; -moz-border-radius: 5px;
								  		-webkit-transition: -webkit-transform 0.3s ease-in-out 0.1s;
